...
export default function Cube() {
    ...
    return (
      <>
        {
          !started && <div className="h-fit p-10 bg-slate-300 rounded flex flex-col place-items-center justify-evenly">
        ...
        {wrong < 3 && started && wrong + correct != 8 && <>
        <h1 className="pb-6 font-bold text-xl">
          <p className="text-green-600 border-2 py-2 px-4 rounded-3xl">{8 - (correct + wrong)} module(s) left</p>
        </h1>
        <div className="aspect-square h-4/5 bg-white grid grid-cols-3 grid-rows-3 gap-1 p-1 rounded shadow-2xl">
